...
export function Features() {
  const features = [
    {
      icon: <Scissors className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />,
    ...
    {
      icon: <Settings className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />,
      title: "Full Control",
  ...
  return (
    <section id="features" className="py-8 bg-slate-50 dark:bg-slate-950 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-8">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-4">Everything you need to clean up audio</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-emerald-300 dark:hover:border-emerald-700 hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
              <div className="w-12 h-12 bg-slate-50 dark:bg-slate-800 rounded-xl shadow-sm flex items-center justify-center mb-4 border border-slate-200 dark:border-slate-700">
                {feature.icon}
              </div>
