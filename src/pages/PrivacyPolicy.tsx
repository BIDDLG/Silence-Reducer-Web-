...
export function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-slate-50 mb-8">Privacy Policy</h1>
      ...
      <div className="prose prose-emerald dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-emerald-200">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">1. Introduction</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">2. Data Processing (100% Client-Side)</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">3. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">4. Cookies and Web Beacons</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">5. Third-Party Privacy Policies</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">6. Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="list-disc pl-6 mt-2">
            <li>By email: <a href="mailto:royalkrrishna@gmail.com" className="text-emerald-600 dark:text-emerald-400 hover:underline">royalkrrishna@gmail.com</a></li>
          </ul>
        </section>
      </div>
    </div>
