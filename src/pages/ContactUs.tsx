...
export function ContactUs() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-slate-50 mb-8">Contact Us</h1>
      ...
      <div className="prose prose-emerald dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-emerald-200">
        ...
        <div className="bg-slate-50 dark:bg-slate-900/50 p-6 sm:p-8 rounded-2xl border border-emerald-200 dark:border-emerald-800 mt-8">
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mb-6">Get in Touch</h2>
          
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-slate-900 dark:text-slate-50">Email Support</h3>
              <p className="mt-1">For general inquiries, support, or feedback, please email us at:</p>
              <a href="mailto:royalkrrishna@gmail.com" className="text-emerald-600 dark:text-emerald-400 hover:underline font-medium text-lg mt-2 inline-block">
                royalkrrishna@gmail.com
              </a>
            </div>
            
            <div className="pt-4 border-t border-emerald-200 dark:border-emerald-700/50">
              <h3 className="font-medium text-slate-900 dark:text-slate-50">Response Time</h3>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mb-4">Advertising & Partnerships</h2>
