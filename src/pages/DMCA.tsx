...
export function DMCA() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-slate-50 mb-8">DMCA Policy</h1>
      ...
      <div className="prose prose-emerald dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-emerald-200">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">Filing a DMCA Notice</h2>
          ...
          <h3 className="text-xl font-semibold text-slate-900 dark:text-emerald-100 mt-6 mb-3">DMCA Notice of Alleged Infringement ("Notice")</h3>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-emerald-100 mt-8 mb-4">Contact Information</h2>
