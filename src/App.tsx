...
export default function App() {
  ...
  if (isLoadingFile) {
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center">
        {/* Yaha spinner ka color green kiya */}
  ...
  return (
    {/* Yaha selection text ka color green kiya */}
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2" onClick={handleReset}>
            {/* Yaha upar header wale chote logo ka color green kiya */}
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-600 dark:text-slate-400">
              {/* Yaha navbar links ka hover color green kiya */}
